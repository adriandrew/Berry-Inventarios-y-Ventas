...
Public Class Clientes
    ...
    Public Function ObtenerListadoReporteCombos() As DataTable
        ...
        Try
            ...
            " ORDER BY Id ASC", ALMLogicaPedidos.Programas.prefijoBaseDatosAlmacen)
    ...
    Public Function ObtenerListadoReporteCatalogo() As DataTable
        ...
        Try
            ...
            Dim comando As New SqlCommand()
            comando.Connection = BaseDatos.conexionCatalogo
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}Clientes ORDER BY Id ASC", ALMLogicaPedidos.Programas.prefijoBaseDatosAlmacen)
            BaseDatos.conexionCatalogo.Open()
            Dim lectorDatos As SqlDataReader
            lectorDatos = comando.ExecuteReader()
            datos.Load(lectorDatos)
