...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaPedidos.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, ALMLogicaPedidos.Directorios.usuarioSql, ALMLogicaPedidos.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaPedidos.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, ALMLogicaPedidos.Directorios.usuarioSql, ALMLogicaPedidos.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionAlmacen()
        ...
        BaseDatos.ECadenaConexionAlmacen = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaPedidos.Directorios.instanciaSql, BaseDatos.ECadenaConexionAlmacen, ALMLogicaPedidos.Directorios.usuarioSql, ALMLogicaPedidos.Directorios.contrasenaSql)
