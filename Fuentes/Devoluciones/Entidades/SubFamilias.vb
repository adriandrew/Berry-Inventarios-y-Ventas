    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            if (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}SubFamilias WHERE 0=0 {1} ORDER BY IdAlmacen, IdFamilia, Id ASC", ALMLogicaDevoluciones.Programas.prefijoBaseDatosAlmacen, condicion)
    ...
    Public Function ObtenerListado() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT IdAlmacen, IdFamilia, Id, Nombre FROM {0}SubFamilias WHERE 0=0 {1}", ALMLogicaDevoluciones.Programas.prefijoBaseDatosAlmacen, condicion)
            comando.Parameters.AddWithValue("@idAlmacen", Me.EIdAlmacen)
            comando.Parameters.AddWithValue("@idFamilia", Me.EIdFamilia)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
