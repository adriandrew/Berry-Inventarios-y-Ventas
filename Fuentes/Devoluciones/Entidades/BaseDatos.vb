...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaDevoluciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, ALMLogicaDevoluciones.Directorios.usuarioSql, ALMLogicaDevoluciones.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaDevoluciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, ALMLogicaDevoluciones.Directorios.usuarioSql, ALMLogicaDevoluciones.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionAlmacen()
        ...
        BaseDatos.ECadenaConexionAlmacen = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaDevoluciones.Directorios.instanciaSql, BaseDatos.ECadenaConexionAlmacen, ALMLogicaDevoluciones.Directorios.usuarioSql, ALMLogicaDevoluciones.Directorios.contrasenaSql)
