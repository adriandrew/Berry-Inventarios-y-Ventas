...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaVentas.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, ALMLogicaVentas.Directorios.usuarioSql, ALMLogicaVentas.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaVentas.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, ALMLogicaVentas.Directorios.usuarioSql, ALMLogicaVentas.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionAlmacen()
        ...
        BaseDatos.ECadenaConexionAlmacen = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaVentas.Directorios.instanciaSql, BaseDatos.ECadenaConexionAlmacen, ALMLogicaVentas.Directorios.usuarioSql, ALMLogicaVentas.Directorios.contrasenaSql)
