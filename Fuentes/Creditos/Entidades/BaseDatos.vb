...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionConfiguracion()
        ...
        BaseDatos.ECadenaConexionConfiguracion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaCreditos.Directorios.instanciaSql, BaseDatos.ECadenaConexionConfiguracion, ALMLogicaCreditos.Directorios.usuarioSql, ALMLogicaCreditos.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaCreditos.Directorios.instanciaSql, BaseDatos.ECadenaConexionCatalogo, ALMLogicaCreditos.Directorios.usuarioSql, ALMLogicaCreditos.Directorios.contrasenaSql)
    ...
    Public Sub AbrirConexionAlmacen()
        ...
        BaseDatos.ECadenaConexionAlmacen = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", ALMLogicaCreditos.Directorios.instanciaSql, BaseDatos.ECadenaConexionAlmacen, ALMLogicaCreditos.Directorios.usuarioSql, ALMLogicaCreditos.Directorios.contrasenaSql)
