    ...
    Public Function ObtenerListadoReporteCatalogo() As DataTable
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}Familias WHERE 0=0 {1} ORDER BY IdAlmacen, Id ASC", ALMLogicaCreditos.Programas.prefijoBaseDatosAlmacen, condicion)
    ...
    Public Function ObtenerListado() As List(Of Familias)
        ...
        Try
            ...
            If (Me.EId > 0) Then
                condicion &= " AND Id=@id"
            End If
            comando.CommandText = String.Format("SELECT IdAlmacen, Id, Nombre FROM {0}Familias WHERE 0=0 {1}", ALMLogicaCreditos.Programas.prefijoBaseDatosAlmacen, condicion)
            comando.Parameters.AddWithValue("@idAlmacen", Me.EIdAlmacen)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
