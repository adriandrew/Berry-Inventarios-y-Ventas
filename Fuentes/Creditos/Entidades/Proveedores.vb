...
Public Class Proveedores
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            If (Me.EId) Then
                condicion &= " AND Id=@id "
            End If
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}Proveedores WHERE 0=0 {1}", ALMLogicaCreditos.Programas.prefijoBaseDatosAlmacen, condicion)
    ...
    Public Function ObtenerListadoReporteCombos() As DataTable
        ...
        Try
            ...
            " ORDER BY Id ASC", ALMLogicaCreditos.Programas.prefijoBaseDatosAlmacen, condicion)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionCatalogo.Open()
            Dim lectorDatos As SqlDataReader
            lectorDatos = comando.ExecuteReader()
    ...
    Public Function ObtenerListadoReporteCatalogo() As DataTable
        ...
        Try
            ...
            Dim comando As New SqlCommand()
            comando.Connection = BaseDatos.conexionCatalogo
            comando.CommandText = String.Format("SELECT Id, Nombre FROM {0}Proveedores ORDER BY Id ASC", ALMLogicaCreditos.Programas.prefijoBaseDatosAlmacen)
            BaseDatos.conexionCatalogo.Open()
            Dim lectorDatos As SqlDataReader
            lectorDatos = comando.ExecuteReader()
            datos.Load(lectorDatos)
